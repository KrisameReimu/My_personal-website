...
export const projects = [
  {
    ...
    milestones: [
      {
        title: '项目启动与概念设计',
        description: '完成游戏核心概念设计、世界观构建、主角设定。确定美术风格为像素艺术风格，参考《空洞骑士》的氛围营造。',
        completedDate: '2023-10-15',
        status: 'completed'
      },
      {
        title: '基础移动系统实现',
        description: '使用C#实现角色的基础移动（行走、跳跃、冲刺）、物理碰撞检测、动画状态机。',
        completedDate: '2023-11-30',
        status: 'completed'
      },
      {
        title: '第一张地图完成',
        description: '设计并实现游戏的第一张主要地图，包含多个平台、可交互对象、隐藏区域。使用Tilemap系统构建关卡。',
        completedDate: '2024-01-20',
        status: 'completed'
      },
      {
        title: '战斗系统开发',
        description: '实现角色攻击动作、伤害判定、敌人AI行为、战斗反馈（击中特效、声音）。',
        completedDate: '2024-03-15',
        status: 'completed'
      },
      {
        title: '解谜机制设计',
        description: '设计并实现各类解谜元素：机关、开关、移动平台、钥匙系统。将谜题融入关卡设计与叙事。',
        completedDate: '2024-05-10',
        status: 'completed'
      },
      {
        title: 'UI系统与存档功能',
        description: '开发游戏UI界面（主菜单、暂停菜单、HUD）、存档读档系统、设置选项。',
        completedDate: '2024-07-01',
        status: 'completed'
      },
      {
        title: '音效与配乐集成',
        description: '使用FMOD集成音效系统，为游戏添加背景音乐、环境音效、战斗音效，增强沉浸感。',
        completedDate: '2024-08-20',
        status: 'completed'
      },
      {
        title: 'Boss战设计与实现',
        description: '设计并实现游戏的Boss战斗，包含多阶段攻击模式、特殊技能、挑战性战斗机制。',
        completedDate: null,
        status: 'in-progress'
      },
      {
      ...
      {
        title: '优化与打磨',
        description: '性能优化、Bug修复、平衡性调整、用户体验改进。准备发布版本。',
        completedDate: null,
        status: 'planned'
      },
      {
        title: '游戏发布',
        description: '在Steam/Itch.io平台发布游戏，准备宣传材料、游戏预告片、社交媒体推广。',
        completedDate: null,
        status: 'planned'
      }
    ],
  ...
  },
  {
    ...
    milestones: [
      ...
      {
        title: '游戏设计文档',
        description: '编写完整的游戏设计文档，明确核心玩法、美术风格、技术需求。',
        completedDate: null,
        status: 'planned'
      }
    ],
...
export const completedProjects = projects.filter(
  p => p.status === ContentCategories.GAME.STATUS.COMPLETED || 
