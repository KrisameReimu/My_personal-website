...
export const videos = [
  {
    ...
    thumbnailUrl: getImageUrl('videos/thumbnails/promo-2024.jpg', {width: 1280}),
  ...
  },
  {
    ...
    thumbnailUrl: getImageUrl('videos/thumbnails/short-film-2023.jpg', {width: 1280}),
    category: 'short-film',
    awards: [
      {
        name: '视频制作项目 - 银奖',
  ...
  },
  {
    ...
    thumbnailUrl: getImageUrl('videos/thumbnails/documentary-2024.jpg', {width: 1280}),
  ...
  },
  {
    ...
    thumbnailUrl: getImageUrl('videos/thumbnails/campus-life-2023.jpg', {width: 1280}),
    category: 'documentary',
    awards: [],
...
export const videosByAwardLevel = {
  ...
  silver: videos.filter(v => v.awards.some(a => a.level === AwardLevels.SILVER)),
  special: videos.filter(v => v.awards.some(a => a.level === AwardLevels.SPECIAL)),
